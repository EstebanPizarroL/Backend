...
let ComunidadesService = exports.ComunidadesService = class ComunidadesService {
    constructor(comunidadModel) {
        this.comunidadModel = comunidadModel;
    }
    async create(createComunidadDto) {
    ...
    async update(id, updateComunidadDto) {
        return this.comunidadModel.findOneAndUpdate({ _id: id }, updateComunidadDto, { new: true });
    }
    async remove(id) {
...
exports.ComunidadesService = ComunidadesService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(comunidades_schema_1.Comunidad.name)),
